...
if($_POST["teacher_id"])    
    ...
    $sql = "INSERT INTO `teacher` (`teacher_id`, `teacher_name`, `teacher_pass`, `teacher_email`) VALUES ('$teacher_id', '$teacher_name', '$teacher_pass', '$teacher_email');";
...
{ 
    ...
    window.location.href='member_t.php';
     </script>"; 
    //return false;
} 
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                       ...
                       <?php 
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="member_s.php">教授名單</a></li>
...
<h2><font size = 8 color ="black">新增教授名單</font></h2><br> 
<body>
    
  <form method="post" action="insert_t.php">
    ...
    <p align=left><font size = 4 color ="black">教授編號:</font>
    <input type="text"  id="" placeholder="請輸入編號" name="teacher_id" required="required"><br>
    ...
    <div style = 'width:350px; height:100px;'>
    <p align=left><font size = 4 color ="black">教授姓名:</font>
    <input type="text"  id="" placeholder="請輸入姓名" name="teacher_name" required="required"><br>
    ...
    <input type="text"  id="" placeholder="請輸入密碼" name="teacher_pass" required="required"><br>
    ...
    <input type="text"  id="" placeholder="請輸入E-mail" name="teacher_email" required="required"><br>
