...
<html lang="en">
    ...
    <body id="page-top" >
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                ...
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">
                       <?php 
                        session_start();
                        echo $_SESSION["manageer_id"];
                        ?></a></li>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index_m.php">首頁</a></li>
        ...
        <!-- Masthead-->
        <header class="masthead text-white text-center"  style="background-color:	#1ECFD6;" >
            <div class="container d-flex align-items-center flex-column">
                ...
                <center>
                <p align=left>
                <font size="5" color="black">姓名:林芯瑜</font><br>
                <font size="5" color="black">學校:輔仁大學</font><br>
                <font size="5" color="black">學號:406401642</font>
                </p>
                </center>
