...
<html lang="en">
    ...
    <tr bgcolor="white">
        ...
        <td width="25%" align="left" style="background-color:#FFF0AC;"><font color="black">開始日期</font></td>
        <td width="25%" align="left" style="background-color:#FFF0AC;"><font color="black">結束日期</font></td>
        <td width="25%" align="left" style="background-color:#FFF0AC;"><font color="black">影片時數</font></td>
...
while($row=mysqli_fetch_array($result,MYSQLI_BOTH))
     {
        ...
        echo"<td width='25%' align='center' style='background-color:#FFFAF2;'><a href='video_s.php?id1=$class&id2=$video'>
        <button class='btn btn-warning btn-sm btn-block-center' style='width:80px;height:50px; background-color:#FFFAF2;' ><font size='4' color = 'black'>觀看</font></button></a></td>";
        echo"</tr>";
