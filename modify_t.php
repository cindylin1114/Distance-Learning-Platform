...
<h2><font size = 8 color ="black">修改教師資料</font></h2><br> 
<body>
    
 <form method="post" action="modify_t.php">
    <center>
    <div style = 'width:750px'> 
    <h3 align="center"><font color="black"><?php echo "欲修改的教師編號 ： ",$id1;?></font></h3><br>
    </div>
    ...
    <td width="50%">
     ...
     <input type="text" id=""  name="teacher_id" value='<?php echo $id1;?>'>
     </div>
    </td>
    <td>
    ...
    <input type="text" id=""  name="teacher_name" value='<?php echo $id3;?>'>
    </div>
     </td> 
    <td>
    <div style = 'width:350px; height:100px;'>
