...
<html lang="en">
    ...
    <body id="page-top" >
        ...
        <center>
     <h2 ><font size = 8 color ="black">教師登入</font></h2><br>
      <form  action = 'login_t1.php' method = "post">
          
    <div class="form-group " style = 'opacity ; width:400px;'>
        <p align=left>
      <label for="acc" align = left><font size = 4 color ="black">帳號:</font></label>
        </p>
      <input type="text" class="form-control" placeholder="請輸入帳號" name="teacher_id" >
    </div>
    <div class="form-group" style = 'opacity ; width:400px;'>
      ...
      <input type="password" class="form-control"  placeholder="請輸入密碼" name="teacher_pass">
    </div>
