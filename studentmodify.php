...
<body>
 ...
 <form method="post" action="studentmodify.php">
    <center>
    ...
    <td width="50%">
     ...
     <p align=left><font size = 4 color ="black">學生編號:</font>
     <input type="text" readonly="readonly"
 id=""  name="student_id" value='<?php echo $id1;?>' >
     </div>
    </td>
    <td>
    ...
    <input type="text" readonly="readonly" id=""  name="student_name" value='<?php echo $id3;?>'>
    </div>
     </td> 
    <td>
    <div style = 'width:350px; height:100px;'>
