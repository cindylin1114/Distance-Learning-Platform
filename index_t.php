...
<html lang="en">
    ...
    <body id="page-top" >
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                       ...
                       <?php echo "登入名稱 :  ",$_SESSION["name"];?>
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index_t.php">首頁</a></li>
      ...
      <center>
            <h2><font size = 6 color ="black">授課課程</font></h2></center><br>
    ...
    <tr bgcolor="white">
        ...
        <td width="25%" align="center" style="background-color:#FFF0AC;"><font color="black">課程人數</font></td>
...
while($row=mysqli_fetch_array($result,MYSQLI_BOTH))
{
    ...
    echo"<td><font color='black'>",$row["class_tname"],"</font></td>";
    
    $class=$row["class_tname"];  
    echo"<td><font color='black'>",$row["class_tclass"],"</font></td>";
    echo"<td><font color='black'>",$row["class_tmember"],"</font></td>";
    echo"<td width='25%' align='center' style='background-color:#FFFAF2;'><a href='videolist_t.php?id=$class'><button class='btn btn-warning btn-sm btn-block-center' style='width:80px;height:50px; background-color:#FFFAF2;' ><font size='4' color = 'black'>觀看</font></button></a></td>";
    echo"</tr>";
