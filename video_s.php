...
<table width="15%" style="border:3px 	#FFD306 solid;position:absolute; left:20px;" cellpadding="8" border='1' align = "left">
...
{            
  $id3=$row1["video_name1"];      
    ...
    if($_POST[$_SESSION["name"]] and $time1 and $time2)    
    {
         
    session_start();
    $sql3 = "INSERT INTO `time` (`student_id`, `video_subject`, `video_name`, `time_check`) VALUES ('{$_SESSION["name"]}', '$time1', '$time2','1');";
...
$result = mysqli_query($conn,$sql);        
     while($row=mysqli_fetch_array($result,MYSQLI_BOTH))
     {
        ...
        echo"<td width='25%' align='center' style='background-color:#FFFAF2;'><a href='video_s.php?id1=$class&id2=$video2'><button class='btn btn-warning btn-sm btn-block-center' style='width:80px;height:50px; background-color:#FFFAF2;' ><font size='4' color = 'black'>觀看</font></button></a></td>";
        echo"</tr>";
...
<!--
        <video src="file/movie.mp4" width="600" height="500" controls autoplay poster="file/img.jpg"></video> 
-->
...
<!-- <form method="post" enctype="multipart/form-data" action="filetime.php"> <input type="submit" value="open" name = "open"> -->
<!-- </form> -->
        </header>
    </body>
</html>
